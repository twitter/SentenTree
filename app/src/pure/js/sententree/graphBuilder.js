...
var module = (function(){
  ...
  function initGraphs(tokens, terms) {
    ...
    var rootSeq = {words:[], newWord:null, graph:null, size:dbsize, DBs:tokenlist};
    var graphs = [];
  ...
  function updateGraphs( tokens, terms, rootSeq, minSupport, maxSupport, graphs, visRootSeq ) {
...
console.log(freqMax);
  ...
  function growGraphs(tokens, terms) {
    if(!tokens) return [];
